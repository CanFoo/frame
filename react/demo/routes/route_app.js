...
exports.index_data = (req, res) => {
    ...
    if (!limit) {
        sendData.data.objects = database.data.objects;
        res.send(JSON.stringify(sendData));
        return false;
    }

    let sendObjs = database.data.objects.slice(offset, offset + limit);
    sendData.data.objects = sendObjs;
